...
urlpatterns = [
    ...
    path("register/<str:user_type>", web_views.register_view, name="register"),
    path("register/<str:user_type>/<str:referral_code>", web_views.register_view, name="register"),
    path("profile", web_views.profile_view, name="profile"),
    path("profile/edit", web_views.profile_edit_view, name="profileEdit"),
    ...
    path("ajax/registeruser", web_views.register_user, name="registerUser"),
    path("ajax/loginuser", web_views.login_user, name="loginUser"),
    path("ajax/updateuser", web_views.update_user, name="updateUser"),
    ...
    path('refer/ajax/patient', refer_views.ajax_refer, name="referpatient"),
    ...
    path('admin/doctor', admin_views.doctored_view, name="referpatient"),
    path('admin/pt', admin_views.ptView, name="referpatient"),
    path('admin/patient', admin_views.patientView, name="referpatient"),
    path('admin/ajax/register', admin_views.ajax_register, name="refer-patient"),
    path('admin/referrals', admin_views.referral_view, name="referpatient"),
